...
def generate_gif_from_frames(
    ...
    if not frames:
        raise RuntimeError("🚫 No valid frames were generated. Please check image paths or bbox data.")
...
if __name__ == "__main__":
    generate_gif_from_frames(
        ...
        json_path=r"C:\Users\qians\Desktop\VGS-dataset\GT_VideoFormat\049_GT_VideoFormat.json",
        model_name="gazelle_dinov2_vitl14",
        ckpt_path=r"C:\Users\qians\Desktop\gazelle-main\gazelle_dinov2_vitl14.pt",
        output_path=r"C:\Users\qians\Desktop\gazelle-main\vis_049_half.gif"
    )
