...
def eval_one_sample(image_np, bbox, gaze, model, transform, device):
    ...
    # 2. 评估指标
    auc = gazefollow_auc(torch.tensor(heat), [gazex_norm], [gazey_norm], h, w).item()
    avg_l2, min_l2 = gazefollow_l2(torch.tensor(heat), gazex_norm, gazey_norm)
    return auc, avg_l2.item(), min_l2.item()
...
if __name__ == "__main__":
    evaluate_video_folder(
        ...
        anno_json_path   = C:\Users\qians\Desktop\gazelle-main\002_GT_VideoFormat.json,
