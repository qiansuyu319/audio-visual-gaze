...
def main():
    ...
    parser.add_argument("--output_dir", type=str, required=False, default='output/semantic_feature', help="Directory to save the transcription files. 推荐放在 output/semantic_feature/ (默认: output/semantic_feature)")
