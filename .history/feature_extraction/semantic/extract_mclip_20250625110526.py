...
def extract_mclip_embeddings(input_txt, output_npy, model_name='M-CLIP/XLM-Roberta-Large-Vit-L-14', batch_size=32):
    """
...
def main():
    ...
    parser.add_argument('--model', type=str, default='M-CLIP/XLM-Roberta-Large-Vit-L-14', help='M-CLIP model name.')
